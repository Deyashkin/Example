console.log("HI animated-headline");
jQuery(document).ready(function ($) {
  ...
  function animateHeadline($headlines) {
    ...
    $headlines.each(function () {
      ...
      if (headline.hasClass("loading-bar")) {
        ...
        setTimeout(function () {
          headline.find(".box-words-wrapper").addClass("is-loading");
        }, barWaiting);
  ...
  function hideWord($word) {
    ...
    if ($word.parents(".box-headline").hasClass("type")) {
      ...
      setTimeout(function () {
        $word.parents(".box-words-wrapper").addClass("is-loading");
      }, barWaiting);
    } else {
      switchWord($word, nextWord);
      setTimeout(function () {
  ...
  function showLetter($letter, $word, $bool, $duration) {
    ...
    if (!$letter.is(":last-child")) {
      ...
      if ($word.parents(".box-headline").hasClass("type")) {
        setTimeout(function () {
          $word.parents(".box-words-wrapper").addClass("waiting");
        }, 200);
      }
      if (!$bool) {
        setTimeout(function () {
